...
[ docker ](https://www.treesir.pub/categories/docker/)
...
- VPS 服务器设置 反向解析 `PTR` (rdns) 记录
  ...
  [![image-20210803123544465](assets/image-20210803123544465.png)](https://cdn.treesir.pub/img/image-20210803123544465.png)
...
- 使用 `certbot` 生成 `letsencrypt` 证书
  ...
  [![image-20210803140906174](assets/image-20210803140906174.png)](https://cdn.treesir.pub/img/image-20210803140906174.png)
  ...
  > |          |                                                              |
  >
  > [![image-20210803141426633](assets/image-20210803141426633.png)](https://cdn.treesir.pub/img/image-20210803141426633.png)
...
[![image-20210803143040167](assets/image-20210803143040167.png)](https://cdn.treesir.pub/img/image-20210803143040167.png)

> 注意生成的记录，需要进行合并起来 才能使用。

[![image-20210803143222296](assets/image-20210803143222296.png)](https://cdn.treesir.pub/img/image-20210803143222296.png)
...
[![image-20210803143453332](assets/image-20210803143453332.png)](https://cdn.treesir.pub/img/image-20210803143453332.png)
...
[![image-20210803144655191](assets/image-20210803144655191.png)](https://cdn.treesir.pub/img/image-20210803144655191.png)

[![image-20210803145009819](assets/image-20210803145009819.png)](https://cdn.treesir.pub/img/image-20210803145009819.png)

## MacOS & Windows 添加邮件记录

- macos

  [![image-20210803145301936](assets/image-20210803145301936.png)](https://cdn.treesir.pub/img/image-20210803145301936.png) [![image-20210803145510252](assets/image-20210803145510252.png)](https://cdn.treesir.pub/img/image-20210803145510252.png)

- window

  > `eM Clien` 工具会自动为我们配置 `IMAP` & `SMTP` 地址信息。

  [![image-20210803150203282](assets/image-20210803150203282.png)](https://cdn.treesir.pub/img/image-20210803150203282.png) [![image-20210803150231988](assets/image-20210803150231988.png)](https://cdn.treesir.pub/img/image-20210803150231988.png)

  [![image-20210803150531520](assets/image-20210803150531520.png)](https://cdn.treesir.pub/img/image-20210803150531520.png) [![image-20210803150604468](assets/image-20210803150604468.png)](https://cdn.treesir.pub/img/image-20210803150604468.png)

## 测试邮件发送

- **Windows to MacOS**

  [![image-20210803151017304](assets/image-20210803151017304.png)](https://cdn.treesir.pub/img/image-20210803151017304.png) [![image-20210803151050244](assets/image-20210803151050244.png)](https://cdn.treesir.pub/img/image-20210803151050244.png)
...
- **Macos to Windows**
  ...
  [![image-20210803151529428](assets/image-20210803151529428.png)](https://cdn.treesir.pub/img/image-20210803151529428.png) [![image-20210803151625536](assets/image-20210803151625536.png)](https://cdn.treesir.pub/img/image-20210803151625536.png)
...
- **Send to Gmail**
  ...
  [![image-20210803152341683](assets/image-20210803152341683.png)](https://cdn.treesir.pub/img/image-20210803152341683.png)
